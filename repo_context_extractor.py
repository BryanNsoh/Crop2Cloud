...
FILE_EXTENSION_EXCLUDE = {".exe", ".dll", ".so", ".pyc", ".json", ".png", ".jpg", ".jpeg", ".log", ".txt"}
...
SPECIFIC_FILES = [
    "writing_materials/cloud functions explained.txt",
    "writing_materials/dashboard.txt",
    "writing_materials/equipment_used.yaml",
    "writing_materials/google_cloud_services_explained.txt",
    "writing_materials/sensor_nomenclature_and_hashing.txt",
    "writing_materials/software_interactions_explained.txt",
    "writing_materials/study_region&experimental_design.yaml",
    "writing_materials/system_description.txt",
]
